...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { description: @award.description, placing: @award.placing, raffle_id: @award.raffle_id, ticket_id: @award.ticket_id } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { description: @award.description, placing: @award.placing, raffle_id: @award.raffle_id, ticket_id: @award.ticket_id } }
