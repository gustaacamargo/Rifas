...
class KindsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kind" do
    assert_difference('Kind.count') do
      post kinds_url, params: { kind: { description: @kind.description, initial_number: @kind.initial_number, number_of_tickets: @kind.number_of_tickets, step: @kind.step } }
    end
  ...
  test "should update kind" do
    patch kind_url(@kind), params: { kind: { description: @kind.description, initial_number: @kind.initial_number, number_of_tickets: @kind.number_of_tickets, step: @kind.step } }
